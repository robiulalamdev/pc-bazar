        ...
        <>
            ...
            <main className='bg-slate-100 h-screen w-screen flex justify-center items-center'>
                <div class="grid grid-cols-1 gap-2 md:min-w-[400px] max-w-[500px] mx-auto h-fit rounded-xl border p-5 shadow bg-white">
                    ...
                    } type="button" class="text-white bg-[#24292F] hover:bg-[#24292F]/90  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark::bg-[#050708]/30 mr-2 mb-2">
                    ...
                    } type="button" class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark: mr-2 mb-2">
